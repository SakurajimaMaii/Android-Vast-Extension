 ...
 */
abstract class BaseVbVmFragment<VB : ViewBinding, VM : ViewModel> : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        mBinding = reflectViewBinding(container, BaseVbVmFragment::class.java)
