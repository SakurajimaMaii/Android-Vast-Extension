...
// Date: 2023/3/14
// Documentation: https://sakurajimamaii.github.io/AVE-DOC/documents/tools/core-topics/app-data-and-files/save-key-value-data/shared-preferences/
 ...
 *
 * @property put Callback when the data in SharedPreferences needs to be
 *     updated.
 * @since 0.5.6
 */
class SharedPreferencesStateFlow<V> internal constructor(
    ...
    /**
     * Updates the [MutableStateFlow.value] atomically using the specified
     * [function] of its value, and returns the new value.
     *
     * [function] may be evaluated multiple times, if [value] is being
     * concurrently updated.
     *
    ...
    /**
     * Updates the [SharedPreferencesStateFlow.value] atomically using the
     * specified [function] of its value.
     *
     * [function] may be evaluated multiple times, if [value] is being
     * concurrently updated.
     *
