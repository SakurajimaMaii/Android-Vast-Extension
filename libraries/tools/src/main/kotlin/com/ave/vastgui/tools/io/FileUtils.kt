...
class ImageFile internal constructor(override val file: File) : MediaFile {
    ...
    companion object : MediaFileProperty {
        /**
        ...
        /**
         * Returns the absolute path to the directory on the primary shared
         * external storage device of the image files where the application can
         * place image files it owns.
         *
        ...
        override fun getExternalFilesDir(subDir: String?): File {
            val file = if (subDir == null) {
                appExternalFilesDir(DIRECTORY_PICTURES)
            } else {
                File(appExternalFilesDir(DIRECTORY_PICTURES), subDir)
            }
            ...
            file.mkDirs(Policy.EXCEPTION).onFailure {
                throw it
            }
