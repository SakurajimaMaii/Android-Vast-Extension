 ...
 */
@JvmOverloads
fun String.safeToInt(defaultValue: Int, radix: Int = 10) = toIntOrNull(radix) ?: defaultValue
 ...
 */
@JvmOverloads
fun String.safeToLong(defaultValue: Long, radix: Int = 10) = toLongOrNull(radix) ?: defaultValue
