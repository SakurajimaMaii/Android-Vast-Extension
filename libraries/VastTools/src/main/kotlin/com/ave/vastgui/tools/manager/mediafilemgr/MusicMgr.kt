...
data object MusicMgr : MediaFileMgr() {
     ...
     * URL [Media.EXTERNAL_CONTENT_URI]. So when you want to delete the music
     ...
     * ```
     *
     * By default, [getFileUriAboveApi30] will only insert the following
     * columns: [Media.DATA], [Media.DISPLAY_NAME], [Media.MIME_TYPE], If you
     * want to customize, you can refer to [getFileUriAboveApi30] by using
     * saveOptions parameter.
     *
     * Since version 0.5.0, [Media.DATE_ADDED] will also be inserted as a
     * default column
     */
    ...
    override fun getFileUriAboveApi30(file: File): Uri? {
        val values = ContentValues().apply {
            ...
            put(Media.MIME_TYPE, "audio/mpeg")
