...
fun EditText.showKeyBroad() {
    val imm = runCatching {
        ...
        Log.e(LogUtil.TAG, "Get InputMethodManager encounter exception:${it.stackTraceToString()}")
        null
    }
    requestFocus()
...
/**
 * Return true if current [event] coordinate is outside the EditView, false otherwise.
 * Here is an example:
 * ```kotlin
 * // In Activity.kt
