...
// Date: 2023/7/3
// Documentation: https://sakurajimamaii.github.io/AVE-DOC/documents/tools/core-topics/connectivity/performing-network-operations/request/
// Documentation: https://sakurajimamaii.github.io/AVE-DOC/documents/tools/core-topics/connectivity/performing-network-operations/response-api/
...
fun RequestWithVM(netVM: NetVM = viewModel()) {
    ...
    Button(
        onClick = {
            netVM.autoRequest(page = 0, size = 2)
        },
